...
CREATE TABLE project (
    ...
    CONSTRAINT project_road_id_fk FOREIGN KEY ( road_id )
        REFERENCES road ( road_id )
);
...
CREATE TABLE staff (
    ...
    CONSTRAINT staff_gender_ch CHECK ( gender = 0 -- ISO/IEC 5218:2022: 0 = not known
                                       OR gender = 1 --  1 = male,
                                       OR gender = 2 -- 2 = female,
                                       OR gender = 9 ), -- 9 = not applicable
    CONSTRAINT staff_role_id_fk FOREIGN KEY ( role_id )
        REFERENCES role ( role_id ),
    CONSTRAINT staff_project_id_fk FOREIGN KEY ( project_id )
...
CREATE TABLE role_history (
    ...
    project_id  NUMBER(16)
        CONSTRAINT role_history_project_id_nn NOT NULL,
    description VARCHAR2(16),
    ...
    CONSTRAINT role_history_role_id_fk FOREIGN KEY ( role_id )
        REFERENCES role ( role_id ),
    CONSTRAINT role_history_project_id_fk FOREIGN KEY ( project_id )
        REFERENCES project ( project_id )
);
